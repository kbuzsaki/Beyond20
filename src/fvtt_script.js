...
ρσ_unpack = ρσ_unpack_asarray(2, ρσ_unpack);
    ...
    (function(){
        ...
        var settings, extension_url, roll_renderer, registered_events, alertify;
        ...
        FVTTDisplayer.prototype.displayError = function displayError(message) {
            var self = this;
            ui.notifications.error(message);
        };
        if (!FVTTDisplayer.prototype.displayError.__argnames__) Object.defineProperties(FVTTDisplayer.prototype.displayError, {
            __argnames__ : {value: ["message"]}
        });
