...
ρσ_unpack = ρσ_unpack_asarray(3, ρσ_unpack);
    ...
    (function(){
        ...
        var settings, fvtt_tabs, manifest, cb, script;
        var c = ρσ_modules.constants;
            ...
            if (new_settings) {
                ...
                getStoredSettings((function() {
                    var ρσ_anonfunc = function (saved_settings) {
                        ...
                        if (settings["show-changelog"] && (settings["last-version"] !== version && (typeof settings["last-version"] !== "object" || ρσ_not_equals(settings["last-version"], version)))) {
                            mergeSettings((function(){
                                var ρσ_d = {};
                                ρσ_d["last-version"] = version;
                                return ρσ_d;
                            }).call(this));
                            chrome.tabs.create((function(){
                                var ρσ_d = {};
                                ρσ_d["url"] = c.CHANGELOG_URL;
                                return ρσ_d;
                            }).call(this));
                        }
                    };
        ...
        function filterVTTTab(request, limit, tabs, titleCB) {
            ...
            if (!found && (limit.id !== 0 && (typeof limit.id !== "object" || ρσ_not_equals(limit.id, 0)))) {
                limit.id = 0;
                mergeSettings((function(){
                    var ρσ_d = {};
                    ρσ_d["vtt-tab"] = limit;
        ...
        if (!addFVTTTab.__argnames__) Object.defineProperties(addFVTTTab, {
            __argnames__ : {value: ["tab"]}
        });
        ...
        if (!removeFVTTTab.__argnames__) Object.defineProperties(removeFVTTTab, {
                ...
                var ρσ_anonfunc = function (tabs) {
                    ...
                    if (found) {
                        sendResponse((function(){
                            ...
                            ρσ_d["error"] = "Found a Foundry VTT tab that has not been activated. Please click on the Beyond20 icon in the browser's toolbar of that tab in order to give Beyond20 access.";
                            return ρσ_d;
                        }).call(this));
                    } else {
                        sendResponse((function(){
        ...
        function onMessage(request, sender, sendResponse) {
            ...
            if (ρσ_in(request.action, ρσ_list_decorate([ "roll", "hp-update", "conditions-update" ]))) {
                ...
                if (ρσ_exists.n(ρσ_exists.d(settings["vtt-tab"]).vtt) && (settings["vtt-tab"].vtt === "dndbeyond" || typeof settings["vtt-tab"].vtt === "object" && ρσ_equals(settings["vtt-tab"].vtt, "dndbeyond"))) {
                    sendResponse((function(){
                        var ρσ_d = {};
                        ρσ_d["success"] = false;
                        ρσ_d["vtt"] = "dndbeyond";
        ...
        function injectFVTTScripts(tab) {
            insertCSSs(ρσ_list_decorate([ tab ]), ρσ_list_decorate([ "libs/css/alertify.css", "libs/css/alertify-themes/default.css", "libs/css/alertify-themes/beyond20.css", "src/beyond20.css" ]));
        ...
        if (!executeScripts.__argnames__) Object.defineProperties(executeScripts, {
            __argnames__ : {value: ["tabs", "js_files"]}
        });
        ...
        if (!onTabsUpdated.__argnames__) Object.defineProperties(onTabsUpdated, {
            __argnames__ : {value: ["id", "changes", "tab"]}
        });

        function onTabRemoved(id, info) {
            removeFVTTTab(id);
        };
        if (!onTabRemoved.__argnames__) Object.defineProperties(onTabRemoved, {
